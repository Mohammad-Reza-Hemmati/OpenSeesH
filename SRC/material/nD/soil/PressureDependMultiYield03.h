...
// $Source: /usr/local/cvs/OpenSees/SRC/material/nD/soil/PressureDependMultiYield03.h,v $

// Written: ZHY
// Created: May 2004


// Description: This file contains the class prototype for PressureDependMultiYield03.
//
// What: "@(#) PressureDependMultiYield03.h, revA"

#ifndef PressureDependMultiYield03_h
#define PressureDependMultiYield03_h
...
public:
     // Initialization constructor
 	 PressureDependMultiYield03(int tag,
		 int nd,
		 double rho,
     ...
     // Return a copy of itself if "code"="PressureDependMultiYield03", otherwise return null.
...
private:
  // user supplied
	 ...
	 static double* contractParam4x;
	 static double* contractParam5x;
